      ...
      <div className="footer-main">
        <div className="footer-container">
          ...
          <div className="footer-column">
            <h3 className="footer-title">ICTUS Saúde</h3>
            <p className="footer-description">
              Comercializamos produtos médicos, odontológicos e hospitalares com
              os mais altos preceitos éticos e de qualidade.
            </p>
            <div className="footer-social">
              ...
              <a
                href="https://www.facebook.com/profile.php?id=61566037895393"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="footer-column">
            ...
            <ul className="footer-contact">
              <li>
                <LocationIcon />
                <span>
                  Rua Presidente Getúlio Vargas, 1951
                  <br />
              ...
              <li>
                <PhoneIcon />
                <a href="tel:+554236221080">(42) 3622-1080</a>
              </li>
              <li>
                <PhoneIcon />
                <a href="tel:+5542991383593">(42) 99138-3593</a>
              </li>
              <li>
                <EmailIcon />
                <a href="mailto:ictus@ictusvirtual.com.br">
            ...
            <div className="footer-hours">
              ...
              <p>Seg - Sex: 8h30 às 18h30</p>
              <p>Sábado: 8h30 às 13h</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="footer-bottom">
        <div className="footer-container">
          <p className="footer-copyright">
            © {currentYear} ICTUS Produtos para Saúde LTDA. Todos os direitos
            reservados.
          </p>
