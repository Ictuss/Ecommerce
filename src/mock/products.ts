...
export const PRODUCTS: Record<string, Product> = {
  "littmann-class-iii-5627": {
    ...
    images: ["/assets/1.png", "/assets/1.png", "/assets/1.png", "/assets/1.png"],
    category: "inverno",
    specs: {
      caracteristicas: [
  ...
  "mae-bebe-monitor": {
    id: "mae-bebe-monitor",
    sku: "1234",
    name: "Monitor Fetal Portátil",
    price: 129900,
    description: "Monitor fetal portátil para acompanhamento seguro do bebê.",
    images: ["/assets/mae-bebe.png"],
    category: "mae-bebe",
    specs: {
      caracteristicas: ["Portátil", "Alta precisão"],
      aplicacao: ["Pré-natal", "Uso doméstico"],
      especificacoes: ["Peso: 200g", "Bateria: 8h"],
      garantia: ["Garantia: 2 anos"]
    }
  },
  "mobilidade-cadeira": {
    id: "mobilidade-cadeira",
    sku: "5678",
    name: "Cadeira de Rodas Ergonômica",
    price: 249900,
    description: "Cadeira de rodas leve e ergonômica para maior mobilidade.",
    images: ["/assets/mobilidade.png"],
    category: "mobilidade",
    specs: {
      caracteristicas: ["Leve", "Dobrável"],
      aplicacao: ["Mobilidade", "Reabilitação"],
      especificacoes: ["Peso: 15kg", "Material: Alumínio"],
